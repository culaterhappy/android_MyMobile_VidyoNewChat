...
public class ApplicationJni extends com.vidyo.VidyoClientLib.LmiAndroidAppJni {
	private static String TAG = "VidyoSampleActivity.LmiApplicationJni";
	...
	public boolean initialize(String caFileName, Activity activity) {
		Log.d(TAG, "initialize...caFileName->" + caFileName + "...activity->" + activity.getLocalClassName());
	...
	public native void doCallByNameDirect(String userName);
	public native void doJoinByName(String userName,String Pin);

	public native void setWindowShares(int currApp,String userName);
